...
Revision ID: 32e55fb5eccd
Revises: 
Create Date: 2024-11-09 17:04:53.405406
...
def upgrade() -> None:
    ...
    sa.Column('modelo_categoria', sa.Enum('DESPESA', 'RECEITA', 'TRANSFERENCIA', 'FATURA', name='tipomovimentacao'), nullable=False),
    sa.Column('id_usuario', sa.BigInteger(), nullable=False),
    ...
    sa.Column('grau_parentesco', sa.String(length=100), nullable=False),
    sa.Column('nome', sa.String(length=60), nullable=False),
    sa.Column('id_usuario', sa.BigInteger(), nullable=False),
    sa.Column('ativo', sa.Boolean(), nullable=True),
    sa.ForeignKeyConstraint(['id_usuario'], ['USUARIO.id_usuario'], ),
    ...
    op.create_table('REPETICAO',
    sa.Column('id_repeticao', sa.BigInteger(), nullable=False),
    sa.Column('quantidade_parcelas', sa.BigInteger(), nullable=False),
    sa.Column('tipo_recorrencia', sa.String(length=100), nullable=False),
    sa.Column('valor_total', sa.DECIMAL(), nullable=False),
    sa.Column('data_inicio', sa.Date(), nullable=False),
    sa.Column('id_usuario', sa.BigInteger(), nullable=False),
    sa.ForeignKeyConstraint(['id_usuario'], ['USUARIO.id_usuario'], ),
    sa.PrimaryKeyConstraint('id_repeticao')
    )
    ...
    sa.Column('descricao', sa.String(length=500), nullable=True),
    sa.Column('tipoMovimentacao', sa.Enum('DESPESA', 'RECEITA', 'TRANSFERENCIA', 'FATURA', name='tipomovimentacao'), nullable=False),
    ...
    sa.Column('parcela_atual', sa.String(length=30), nullable=True),
    sa.Column('data_pagamento', sa.Date(), nullable=False),
    sa.Column('participa_limite_fatura_gastos', sa.Boolean(), nullable=True),
    sa.Column('id_conta', sa.BigInteger(), nullable=True),
    sa.Column('id_categoria', sa.BigInteger(), nullable=True),
    sa.Column('id_fatura', sa.BigInteger(), nullable=True),
    sa.Column('id_repeticao', sa.BigInteger(), nullable=True),
    sa.Column('id_usuario', sa.BigInteger(), nullable=False),
    sa.Column('id_conta_destino', sa.BigInteger(), nullable=True),
    ...
    sa.ForeignKeyConstraint(['id_repeticao'], ['REPETICAO.id_repeticao'], ),
    sa.ForeignKeyConstraint(['id_usuario'], ['USUARIO.id_usuario'], ),
